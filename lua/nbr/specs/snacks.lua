...
return {
    ...
    keys = function()
        return {
            ...
            { "<leader>wd",          function() Snacks.picker.smart({ filter = { cwd = true }}) end, desc = "[D]ocument (Smart)" },
            { "<C-r>",               function() Snacks.picker.smart({ filter = { cwd = true }}) end, desc = "[D]ocument (Smart)" },
